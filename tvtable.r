...
if bar_index == 0
    table.cell(ema_table, 0, 0, text="Time", bgcolor=color.new(color.blue, 85), text_color=color.white)
...
get_rsi_color(rsi) =>
    rsi > 70 ? color.new(#FF4C4C, 0) : rsi < 30 ? color.new(#00FF00, 0) : color.new(color.gray, 85)
...
table.cell(ema_table, 2, 1, text=str.tostring(rsi_1m, format.mintick), bgcolor=color.new(color.gray, 85), text_color=color.white)
...
table.cell(ema_table, 2, 2, text=str.tostring(rsi_3m, format.mintick), bgcolor=color.new(color.gray, 85), text_color=color.white)
...
table.cell(ema_table, 2, 3, text=str.tostring(rsi_5m, format.mintick), bgcolor=color.new(color.gray, 85), text_color=color.white)
...
table.cell(ema_table, 2, 4, text=str.tostring(rsi_15m, format.mintick), bgcolor=color.new(color.gray, 85), text_color=color.white)
...
table.cell(ema_table, 2, 5, text=str.tostring(rsi_1h, format.mintick), bgcolor=color.new(color.gray, 85), text_color=color.white)
...
table.cell(ema_table, 2, 6, text=str.tostring(rsi_4h, format.mintick), bgcolor=color.new(color.gray, 85), text_color=color.white)
...
table.cell(ema_table, 2, 7, text=str.tostring(rsi_1d, format.mintick), bgcolor=color.new(color.gray, 85), text_color=color.white)
